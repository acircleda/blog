...
iris %>%
  ...
  tab_footnote(
    #footnote text
    footnote = "This is a footnore.",
    # add to the column labels section
    locations = cells_column_labels(
      # add to the "Species" column
