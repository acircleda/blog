...
library(tidyverse)
```
**(TL;DR: [Here is the calculator](https://github.com/acircleda/Flight-Emissions-Calculator))**
...
We can also calculate distance and add to an existing dataframe using `mutate` and calculate multiple itineraries at the same time. Here is some example data
